...
public interface RegistryService {
     ...
     */
    void subscribe(RpcDesc url, NotifyListener listener);
     ...
     * @param listener A listener of the change event, not allowed to be empty
     */
    void unsubscribe(RpcDesc url, NotifyListener listener);
     ...
     */
    List<RpcDesc> lookup(RpcDesc url);
